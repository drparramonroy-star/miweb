...
import { trackBmiCalculated, trackWhatsAppClick } from '../../lib/analytics/events';
...
export const BmiCalculatorSection = ({ phone }: BmiCalculatorSectionProps) => {
  ...
  const calculateBMI = (e: React.FormEvent) => {
    ...
    if (w > 0 && h > 0) {
      ...
      trackBmiCalculated(result, category.label, category.candidate);
    }
  };
                ...
                {getImcCategory(imc).candidate ? (
                  <div className="bg-blue-50/50 p-5 rounded-2xl text-center border border-blue-100/50">
                    ...
                    <a
                      ...
                      onClick={() => trackWhatsAppClick('bmi_result')}
